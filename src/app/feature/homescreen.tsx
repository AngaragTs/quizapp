  ...
  return (
    <div className="w-full h-screen bg-white">
      ...
      <div className="w-full h-full flex">
        {(sidebar && (
          <div
            className="h-full w-80 border-r-2 border-[#e4e4e7] flex justify-center pt-5"
            onClick={() => setSidebar(false)}
          >
            <GoSidebarCollapse className="text-black w-8 h-8" />
          </div>
        )) || (
          <div className="h-full w-[4%] border-r-2 border-[#e4e4e7] bg-amber-400 flex justify-center pt-5">
            <GoSidebarCollapse
        ...
        <div className="w-full h-full flex  px-72 justify-center">
          <div className="w-214 h-110 border flex-col rounded-xl flex justify-center ">
